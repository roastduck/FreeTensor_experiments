...
int main(int argc, char **argv) {
    ...
    enzyme_render_main(soft_colors, faces, textures);

    /*print(soft_colors, "./result/enzyme_soft_colors.txt",
          {batch_size, 4, image_size, image_size});
    print(d_faces, "./result/enzyme_grad_faces.txt",
          {batch_size, num_faces, 3, 3});
    print(d_textures, "./result/enzyme_grad_textures.txt",
